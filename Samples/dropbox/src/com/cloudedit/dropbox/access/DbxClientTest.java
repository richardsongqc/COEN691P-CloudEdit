...
public class DbxClientTest
{
        ...
        throws Exception
    {
        ...
        String strAccessToken = DropboxAuth.getAccessToken();
        DbxRequestConfig requestConfig = new DbxRequestConfig("sdk-test", null);
        DbxClient client = new DbxClient(requestConfig, strAccessToken, DbxHost.Default);
        ...
        testFolder = entry.path;
        DbxClientTest.client = client;
    }
    ...
    @Test
    public static void testUploadAndDownload()
        throws Exception
    {
